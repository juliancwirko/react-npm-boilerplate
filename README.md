...
3. If you want to run tests: `npm test` or `npm run testonly` or `npm run test-watch`. You need to write tests in `__test__` folder. You need at least Node 4 on your machine to run tests.
